...
## Generate completions
#python generate_completions.py --test_cases_path test_cases/ImgJP_test_cases.json --save_path completions/imgjp_completions.json --model_name llava_v1_5
...
## Attack
python generate_test_cases.py --method_name DeltaJP --save_dir test_cases/DeltaJP_test_cases --behaviors_path ./data/behavior_datasets/harmbench_behaviors_multimodal_all.csv --overwrite
