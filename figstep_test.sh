...
## Generate completions
python generate_completions.py --test_cases_path test_cases/Visual_Adv_test_cases.json --save_path completions/Visual_Adv_completions.json --model_name minigpt4
